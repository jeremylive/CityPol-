...
public class IConstants 
{
    ...
    public static final int medidaNodo = 2;
    public static final int escalaImagen = 8;
    public static final String APIKEY = "AIzaSyCJ7uTZXf0src8yg-ZAyrYbQhAKhcrPtMg";
    public static final String APIRequest = "?location=48.8587737,2.3491262&radius=500&type=restaurant&key=AIzaSyCJ7uTZXf0src8yg-ZAyrYbQhAKhcrPtMg";
    public static final String[] tipos = {"park","restaurant","museum","bar","bank", "cafe","church", "hospital", "night_club", "liquor_store"};
    public static final int nodosPorPeticion = 3;
    public static final int pedidosPorJuego = 5;
